...
;;; frank_ayu_mirage-theme.el --- Theme 
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   (custom-theme-set-faces
    ...
    ;;;;; basics
     ...
     `(line-number ((,class (:background ,bg1 :foreground ,comment))))
     `(line-number-current-line ((,class (:background ,bg1 :foreground ,keyword))))
...
(provide-theme 'frank_ayu_mirage)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; frank_ayu_mirage-theme.el ends here
