        ...
        (powerline--expand-alist
         `((("SPLIT")
           ...
           (("static_str")
            ...
            (hybrid      ,white           ,darkblue)
           (insert      ,white           ,darkblue))

           (("fileinfo.flags")
            (normal      ,brightestred    nil          t)
            (inactive    ,darkred)
            (hybrid      ,brightestred    nil          t)
