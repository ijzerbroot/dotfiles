...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(tabbar restclient base16-theme lsp-mode lsp-ui challenger-deep-theme groovy-mode sr-speedbar cask god-mode kubernetes sourcerer-theme doom doom-themes hcl-mode all-the-icons eyebrowse go-autocomplete)
