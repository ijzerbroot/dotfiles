...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(gradle-mode sr-speedbar beacon cask kubernetes lsp-mode lsp-java lsp-javacomp sourcerer-theme doom doom-themes hcl-mode all-the-icons eyebrowse go-autocomplete)
...
This function is called at the very startup of Spacemacs initializatio
