...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(magit beacon cask treemacs kubernetes lsp-mode lsp-java lsp-javacomp sourcerer-theme doom doom-themes hcl-mode all-the-icons eyebrowse go-autocomplete)
...
values."
  ...
  (setq-default
   ...
   ;; Transparency can be toggled through `toggle-transparency'. (default 90)
   dotspacemacs-inactive-transparency 82
