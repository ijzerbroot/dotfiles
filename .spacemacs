...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(zoom sr-speedbar sublimity beacon cask treemacs kubernetes lsp-mode lsp-java lsp-javacomp sourcerer-theme doom doom-themes hcl-mode all-the-icons eyebrowse go-autocomplete)
