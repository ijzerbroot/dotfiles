...
(when (display-graphic-p)
  ;; Set default font
  (catch 'loop
    (dolist (font '("SF Mono" "Hack Nerd Font Regular" "Hack NF" "Source Code Pro" "Fira Code"
